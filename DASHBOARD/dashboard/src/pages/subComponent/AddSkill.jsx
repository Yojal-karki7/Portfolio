...
import { addNewSkills, clearAllSkillSliceErrors, getAllSkills, resetSkillSlice } from '@/store/slices/skillSlice'
          ...
          <div className="space-y-12">
            ...
            <div className="mt-10 flex flex-col gap-6">
                ...
                <div className="w-full sm:col-span-4">
                  ...
                  <div className="mt-2">
                    <div className="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600">
                      <Input type='text' placeholder='Proficiency' value={proficiency} onChange={(e)=>setProficiency(e.target.value)} className='block flex-1 border-0 bg-transparent py-1.5 pl-1 text-gray-900 placeholder:text-gray-400 focus:ring-0 sm:text-sm sm:leading-6'/>
                    </div>
                  </div>
                </div>
            ...
            {
              loading ? <SpecialLoadingButton content={'Adding'}/> : <Button type='submit' className='w-full'>Add Skill</Button>
            }
          </div>
        </form>
      </div>
